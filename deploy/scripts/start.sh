...
nohup java -jar \
  -Dspring.config.location="$PROJECT_ROOT/application-$IDLE_PROFILE".yml,"$PROJECT_ROOT/application-key.yml","$PROJECT_ROOT/application-$DEPLOY_ENV-db.yml","$PROJECT_ROOT/application-email.yml" \
